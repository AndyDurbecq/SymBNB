...
class User implements UserInterface
{
     ...
     * @Assert\Url(message="Merci de renseigner une url !")
     */
    private $picture;
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\Length(min=10, minMessage="Introduction de minimum 10 caractères !")
     */
    private $introduction;

    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=100, minMessage="Introduction de minimum 100 caractères !")
     */
    private $description;
